...
- **User Interaction (`input()` & `print()`)**  
  Implemented interactive programs by collecting user input and displaying meaningful outputs, improving usability and engagement.

  <img width="400" height="100" alt="image" src="https://github.com/user-attachments/assets/b2a2446d-3b34-440e-a704-43b4c71778e5" />


- **Conditional Logic (`if`, `elif`, `else`)**  
  Built decision-making logic to control program flow, such as checking conditions and executing different actions based on user input or data values.

 <img width="400" height="200" alt="image" src="https://github.com/user-attachments/assets/7094349a-4367-471c-a903-a2019adbed28" />


- **Loops (`for` and `while`)**  
  Used loops to automate repetitive tasks and iterate through data, enabling efficient processing and scalable solutions.
...
- Perform calculations using modulo operations  
